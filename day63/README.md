...
.\.venv\Scripts\python.exe tools\materialize_day.py 63
cd .build\day63\customer-support
...
本地共享 secret 不等于企业 SSO。把实际运行结果写入 `workbook.md`。
